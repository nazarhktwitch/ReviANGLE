...
#define GLP_EXT_FORWARD(ret, name, sig, args)                                  \
  ...
  extern "C" __declspec(dllexport) ret WINAPI gl_gl##name sig {                \
    ...
    if (!p)                                                                    \
      p = (PFN_##name)glproxy::resolve("gl" #name);                            \
...
gl_glDrawBuffers(GLsizei n, const GLenum *bufs) {
  static PFN_DB_PLURAL p = nullptr;
  if (!p)
    p = (PFN_DB_PLURAL)glproxy::resolve("glDrawBuffers");
  static int dn = 0;
  if (dn < 60) {
    char desc[128] = {};
    if (n == 0) {
...
// glDrawBuffer is desktop-GL only; ANGLE/GLES has only the plural
// glDrawBuffers. Compatibility shim for mods written against desktop GL
// (peony.silicate etc.): translate the singular form into the plural form.
...
GLP_EXT_FORWARD_VOID(GetVertexAttribiv,
                     ...
                     (index, pname, params))
GLP_EXT_FORWARD_VOID(GetVertexAttribPointerv,
...
gl_glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat, GLint x,
  ...
  typedef void(WINAPI * PFN_CTI)(GLenum, GLint, GLenum, GLint, GLint, GLsizei,
                                 GLsizei, GLint);
  static PFN_CTI p = nullptr;
  if (!p)
    p = (PFN_CTI)glproxy::resolve("glCopyTexImage2D");
  static int n = 0;
  if (Config::get().megahack_detected && n < 80) {
    angle::forceLog("glCopyTexImage2D #%d: target=0x%04X level=%d ifmt=0x%04X "
                    "src=%d,%d size=%dx%d border=%d",
                    n, target, level, internalformat, x, y, width, height,
                    border);
    n++;
  }
  if (p)
...
gl_glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
  ...
  typedef void(WINAPI * PFN_CTSI)(GLenum, GLint, GLint, GLint, GLint, GLint,
                                  GLsizei, GLsizei);
  static PFN_CTSI p = nullptr;
  if (!p)
    p = (PFN_CTSI)glproxy::resolve("glCopyTexSubImage2D");
  static int n = 0;
  if (Config::get().megahack_detected && n < 80) {
    angle::forceLog("glCopyTexSubImage2D #%d: target=0x%04X level=%d dst=%d,%d "
                    "src=%d,%d size=%dx%d",
                    n, target, level, xoffset, yoffset, x, y, width, height);
    n++;
  }
  if (p)
...
// GetTexParameter
GLP_EXT_FORWARD_VOID(GetTexParameteriv,
                     (GLenum target, GLenum pname, GLint *params),
                     (target, pname, params))
GLP_EXT_FORWARD_VOID(GetTexParameterfv,
...
static int s_bufTargetSlot(GLenum target) {
  switch (target) {
  case 0x8892:
    return 0; // GL_ARRAY_BUFFER
  case 0x8893:
    return 1; // GL_ELEMENT_ARRAY_BUFFER
  case 0x88EB:
    return 2; // GL_PIXEL_PACK_BUFFER
  case 0x88EC:
    return 3; // GL_PIXEL_UNPACK_BUFFER
  case 0x8A11:
    return 4; // GL_UNIFORM_BUFFER
  case 0x8C8E:
    return 5; // GL_TRANSFORM_FEEDBACK_BUFFER
  case 0x8F36:
    return 6; // GL_COPY_READ_BUFFER
  case 0x8F37:
    return 7; // GL_COPY_WRITE_BUFFER
  default:
...
extern "C" __declspec(dllexport) void WINAPI gl_glBindBuffer(GLenum target,
                                                             GLuint buffer) {
  static PFN_BB p = nullptr;
  if (!p)
    p = (PFN_BB)glproxy::resolve("glBindBuffer");
  int slot = s_bufTargetSlot(target);
  if (slot >= 0) {
    if (g_bufferBindings[slot] == buffer)
      return;
...
extern "C" __declspec(dllexport) void WINAPI gl_glBufferData(GLenum target,
  ...
  if (!p)
    p = (PFN_BD)glproxy::resolve("glBufferData");
  if (gd_noBufferBound(target))
    return; // desktop-GL parity: silent no-op
  if (p)
    p(target, size, data, usage);
}
typedef void(WINAPI *PFN_BSD)(GLenum, GLintptr, GLsizeiptr, const void *);
extern "C" __declspec(dllexport) void WINAPI gl_glBufferSubData(
    GLenum target, GLintptr offset, GLsizeiptr size, const void *data) {
  static PFN_BSD p = nullptr;
  if (!p)
    p = (PFN_BSD)glproxy::resolve("glBufferSubData");
  if (gd_noBufferBound(target))
    return; // desktop-GL parity: silent no-op
  if (p)
...
extern "C" __declspec(dllexport) void WINAPI
gl_glDeleteBuffers(GLsizei n, const GLuint *buffers) {
  static PFN_DeleteBuffers p = nullptr;
  if (!p)
    p = (PFN_DeleteBuffers)glproxy::resolve("glDeleteBuffers");
  if (p)
    p(n, buffers);
  if (!buffers || n <= 0)
    return;
...
GLP_EXT_FORWARD(void *, MapBufferRange,
...
GLP_EXT_FORWARD_VOID(GetBufferParameteriv,
                     (GLenum target, GLenum pname, GLint *params),
                     (target, pname, params))
...
extern "C" __declspec(dllexport) void WINAPI
gl_glBindVertexArray(GLuint array) {
  static PFN_BVA p = nullptr;
  if (!p)
    p = (PFN_BVA)glproxy::resolve("glBindVertexArray");
  if (array == g_currentVAO)
    return;
  g_currentVAO = array;
...
GLP_EXT_FORWARD_VOID(DeleteVertexArrays, (GLsizei n, const GLuint *arrays),
                     (n, arrays))
...
extern "C" __declspec(dllexport) GLuint WINAPI gl_glCreateShader(GLenum type) {
  ...
  if (!p)
    p = (PFN_CS)glproxy::resolve("glCreateShader");
  GLuint id = p ? p(type) : 0;
  if (id == 0) {
    angle::forceLog("CreateShader FAIL: type=0x%04X (resolved=%d)", type,
                    p ? 1 : 0);
  } else {
    std::lock_guard<std::mutex> lk(g_shaderTypeMtx);
    g_shaderType[id] = type;
  }
  return id;
}
...
static void stripUniformLayouts(std::string &src) {
  ...
  while ((pos = src.find("layout", pos)) != std::string::npos) {
    ...
    if (endOfWord < src.size() &&
        (std::isalnum(src[endOfWord]) || src[endOfWord] == '_')) {
      pos += 6;
      continue;
    }
    ...
    while (nextWordStart < src.size() &&
           std::isspace((unsigned char)src[nextWordStart])) {
      nextWordStart++;
    }

    if (nextWordStart + 7 <= src.size() &&
        src.compare(nextWordStart, 7, "uniform") == 0) {
      char nextChar =
          (nextWordStart + 7 < src.size()) ? src[nextWordStart + 7] : '\0';
...
typedef void(WINAPI *PFN_SS)(GLuint, GLsizei, const GLchar *const *,
                             const GLint *);

extern "C" __declspec(dllexport) void WINAPI
gl_glShaderSource(GLuint shader, GLsizei count, const GLchar *const *string,
                  const GLint *length) {
  static PFN_SS p = nullptr;
  if (!p)
    p = (PFN_SS)glproxy::resolve("glShaderSource");
  if (!p)
    return;
  ...
  bool isFragment = false;
  {
    ...
    if (it != g_shaderType.end() && it->second == 0x8B30 /*GL_FRAGMENT_SHADER*/)
      isFragment = true;
  }
  ...
  if (versionPos == std::string::npos) {
    ...
    if (numPos != std::string::npos) {
      for (size_t i = numPos;
           i < verLine.size() && verLine[i] >= '0' && verLine[i] <= '9'; i++) {
    ...
    while (injectPos < src.size()) {
      ...
      if (!(isExt || isBlank || isLineComment))
        break;
      ...
      if (isExt && toEs3) {
        ...
        static const char *kStripExt[] = {
            ...
            "GL_ARB_explicit_uniform_location", // not in ES 3.00, no
                                                // replacement
  ...
  static int n = 0;
  angle::log("ShaderSource patch #%d shader=%u type=%s (orig %zu B -> patched "
             "%zu B, hasVersion=%d)",
             n, shader, isFragment ? "FRAG" : "VERT", src.size(),
             patched.size(), versionPos != std::string::npos);
  n++;
}
...
extern "C" __declspec(dllexport) void WINAPI gl_glCompileShader(GLuint shader) {
  ...
  if (!p)
    p = (PFN_CMP)glproxy::resolve("glCompileShader");
  if (p)
    p(shader);
  ...
  if (pgsv) {
    GLint cs = -1;
    pgsv(shader, 0x8B81 /*GL_COMPILE_STATUS*/, &cs);
    if (cs == 0) {
      char buf[512] = {};
      if (pgsil)
        pgsil(shader, 511, nullptr, buf);
...
GLP_EXT_FORWARD_VOID(GetShaderiv, (GLuint shader, GLenum pname, GLint *params),
                     (shader, pname, params))
GLP_EXT_FORWARD_VOID(GetShaderInfoLog,
                     (GLuint shader, GLsizei bufSize, GLsizei *length,
                      GLchar *infoLog),
                     (shader, bufSize, length, infoLog))
GLP_EXT_FORWARD_VOID(GetShaderSource,
                     (GLuint shader, GLsizei bufSize, GLsizei *length,
                      GLchar *source),
                     (shader, bufSize, length, source))
GLP_EXT_FORWARD(GLboolean, IsShader, (GLuint shader), (shader))

extern "C" __declspec(dllexport) GLuint WINAPI
gl_glCreateShaderObjectARB(GLenum type) {
  return gl_glCreateShader(type);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glShaderSourceARB(GLuint shader, GLsizei count, const GLchar *const *string,
                     const GLint *length) {
  gl_glShaderSource(shader, count, string, length);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glCompileShaderARB(GLuint shader) {
  gl_glCompileShader(shader);
}
...
extern "C" __declspec(dllexport) GLuint WINAPI gl_glCreateProgram(void) {
  ...
  if (!p)
    p = (PFN_CP)glproxy::resolve("glCreateProgram");
  GLuint id = p ? p() : 0;
  if (id == 0)
    angle::forceLog("CreateProgram FAIL (resolved=%d)", p ? 1 : 0);
  return id;
}
...
extern "C" __declspec(dllexport) void WINAPI
gl_glDeleteProgram(GLuint program) {
  static PFN_DP p = nullptr;
  if (!p)
    p = (PFN_DP)glproxy::resolve("glDeleteProgram");
  if (p)
    p(program);
  ...
  if (program != 0 && program == g_currentProgram) {
    ...
    if (!pGetI)
      pGetI = (PFN_GIV_DP)glproxy::resolve("glGetIntegerv");
    if (pGetI) {
      GLint actual = 0;
...
GLP_EXT_FORWARD_VOID(AttachShader, (GLuint program, GLuint shader),
                     (program, shader))
GLP_EXT_FORWARD_VOID(DetachShader, (GLuint program, GLuint shader),
                     (program, shader))
...
extern "C" __declspec(dllexport) void WINAPI gl_glLinkProgram(GLuint program) {
  ...
  if (!p)
    p = (PFN_LP)glproxy::resolve("glLinkProgram");
  if (p)
    p(program);
  ...
  if (!pgpiv)
    pgpiv = (PFN_GPV)glproxy::resolve("glGetProgramiv");
  GLint ls = 1; // assume OK if we can't query
  if (pgpiv)
    pgpiv(program, 0x8B82 /*GL_LINK_STATUS*/, &ls);
  if (program < 16384) {
    g_programLinked[program].store((ls != 0) ? 2 : 1,
...
extern "C" bool gdangle_currentProgramOK() {
  ...
  if (g_currentProgram == 0)
    return false; // no program → ANGLE fastfails
  ...
  if (!pGetIv)
    pGetIv = (PFN_GIV3)glproxy::resolve("glGetIntegerv");
  if (!pGetPv)
    pGetPv = (PFN_GPV2)glproxy::resolve("glGetProgramiv");
  if (!pGetPv)
    return true; // can't verify → assume OK

  // If we fell through from fast path we already have the real ID.
  GLint cur = (g_currentProgram != 0xFFFFFFFFu) ? (GLint)g_currentProgram : 0;
  if (cur == 0 && pGetIv) {
    pGetIv(0x8B8D /*GL_CURRENT_PROGRAM*/, &cur);
  }
  if (cur <= 0)
    return false; // no program bound

  // Per-thread cache of last-seen (program, OK?) pair to avoid repeated
...
// Called from wglSwapBuffers to force a fresh program-status check at frame
// start. This catches the case where silicate deleted+recreated a program
// between frames without going through our gl_glDeleteProgram /
// gl_glLinkProgram proxy.
extern "C" void gdangle_invalidateProgramCache() {
  ...
  // way: do a single glGetIntegerv here to sync g_currentProgram with ANGLE
  // reality.
...
extern "C" __declspec(dllexport) void WINAPI gl_glUseProgram(GLuint program) {
  ...
  static int n = 0;
  if (n < 40)
    angle::forceLog("glUseProgram #%d: prog=%u (was prog=%u)", n, program,
                    g_currentProgram == 0xFFFFFFFFu ? 0xFFFFFFFFu
                                                    : g_currentProgram);
  n++;
  if (p)
    p(program);
...
GLP_EXT_FORWARD_VOID(GetProgramiv,
                     (GLuint program, GLenum pname, GLint *params),
                     (program, pname, params))
GLP_EXT_FORWARD_VOID(GetProgramInfoLog,
...
extern "C" __declspec(dllexport) GLuint WINAPI gl_glCreateProgramObjectARB() {
  return gl_glCreateProgram();
}
extern "C" __declspec(dllexport) void WINAPI
gl_glAttachObjectARB(GLuint program, GLuint shader) {
  gl_glAttachShader(program, shader);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glDetachObjectARB(GLuint program, GLuint shader) {
  gl_glDetachShader(program, shader);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glLinkProgramARB(GLuint program) {
  gl_glLinkProgram(program);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glUseProgramObjectARB(GLuint program) {
  gl_glUseProgram(program);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glValidateProgramARB(GLuint program) {
  gl_glValidateProgram(program);
}
extern "C" __declspec(dllexport) void WINAPI gl_glDeleteObjectARB(GLuint obj) {
  if (gl_glIsShader(obj))
    gl_glDeleteShader(obj);
  else if (gl_glIsProgram(obj))
    gl_glDeleteProgram(obj);
}
extern "C" __declspec(dllexport) GLuint WINAPI gl_glGetHandleARB(GLenum pname) {
  if (pname != 0x8B40 /*GL_PROGRAM_OBJECT_ARB*/)
    return 0;
  typedef void(WINAPI * PFN_GIV_ARB)(GLenum, GLint *);
  static PFN_GIV_ARB pGetI = nullptr;
  if (!pGetI)
    pGetI = (PFN_GIV_ARB)glproxy::resolve("glGetIntegerv");
  GLint cur = 0;
  if (pGetI)
    pGetI(0x8B8D /*GL_CURRENT_PROGRAM*/, &cur);
  return (GLuint)cur;
}
extern "C" __declspec(dllexport) void WINAPI gl_glGetAttachedObjectsARB(
    GLuint program, GLsizei maxCount, GLsizei *count, GLuint *objects) {
  typedef void(WINAPI * PFN_GAS_ARB)(GLuint, GLsizei, GLsizei *, GLuint *);
  static PFN_GAS_ARB pGetAttachedShaders = nullptr;
  if (!pGetAttachedShaders)
    pGetAttachedShaders = (PFN_GAS_ARB)glproxy::resolve("glGetAttachedShaders");
  if (pGetAttachedShaders)
    pGetAttachedShaders(program, maxCount, count, objects);
  else if (count)
    *count = 0;
}
extern "C" __declspec(dllexport) void WINAPI
gl_glGetObjectParameterivARB(GLuint obj, GLenum pname, GLint *params) {
  if (!params)
    return;
  if (pname == 0x8B4E /*GL_OBJECT_TYPE_ARB*/) {
    if (gl_glIsProgram(obj))
      *params = 0x8B40 /*GL_PROGRAM_OBJECT_ARB*/;
    else if (gl_glIsShader(obj))
      *params = 0x8B48 /*GL_SHADER_OBJECT_ARB*/;
    else
      *params = 0;
    return;
  }
  ...
  if (gl_glIsShader(obj))
    gl_glGetShaderiv(obj, pname, params);
  else if (gl_glIsProgram(obj))
    gl_glGetProgramiv(obj, pname, params);
  else
    *params = 0;
}
extern "C" __declspec(dllexport) void WINAPI
gl_glGetObjectParameterfvARB(GLuint obj, GLenum pname, GLfloat *params) {
  if (!params)
    return;
  GLint value = 0;
...
extern "C" __declspec(dllexport) void WINAPI gl_glGetInfoLogARB(
    GLuint obj, GLsizei maxLength, GLsizei *length, GLchar *infoLog) {
  if (gl_glIsShader(obj))
    gl_glGetShaderInfoLog(obj, maxLength, length, infoLog);
  else if (gl_glIsProgram(obj))
    gl_glGetProgramInfoLog(obj, maxLength, length, infoLog);
  else {
    if (length)
      *length = 0;
...
GLP_EXT_FORWARD_VOID(BindAttribLocation,
                     (GLuint program, GLuint index, const GLchar *name),
                     (program, index, name))
GLP_EXT_FORWARD(GLint, GetAttribLocation, (GLuint program, const GLchar *name),
                (program, name))
GLP_EXT_FORWARD_VOID(GetActiveAttrib,
                     (GLuint program, GLuint index, GLsizei bufSize,
                      GLsizei *length, GLint *size, GLenum *type, GLchar *name),
                     (program, index, bufSize, length, size, type, name))
GLP_EXT_FORWARD_VOID(GetActiveUniform,
                     (GLuint program, GLuint index, GLsizei bufSize,
                      GLsizei *length, GLint *size, GLenum *type, GLchar *name),
                     (program, index, bufSize, length, size, type, name))

// Uniforms
GLP_EXT_FORWARD(GLint, GetUniformLocation, (GLuint program, const GLchar *name),
                (program, name))
...
template <typename T, int K> struct UniCache {
  GLuint prog;
  GLint loc;
  T val[K];
};
...
extern "C" __declspec(dllexport) void WINAPI gl_glUniform1f(GLint location,
                                                            GLfloat v0) {
  static PFN_U1F p = nullptr;
  if (!p)
    p = (PFN_U1F)glproxy::resolve("glUniform1f");
  if (gd_noProgramBound())
    return;
  if (location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    ...
    if (e.prog == g_currentProgram && e.loc == location && e.val[0] == v0)
      return;
...
extern "C" __declspec(dllexport) void WINAPI gl_glUniform2f(GLint location,
                                                            GLfloat v0,
                                                            GLfloat v1) {
  static PFN_U2F p = nullptr;
  if (!p)
    p = (PFN_U2F)glproxy::resolve("glUniform2f");
  if (gd_noProgramBound())
    return;
  if (location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
...
extern "C" __declspec(dllexport) void WINAPI gl_glUniform3f(GLint location,
                                                            GLfloat v0,
                                                            GLfloat v1,
                                                            GLfloat v2) {
  static PFN_U3F p = nullptr;
  if (!p)
    p = (PFN_U3F)glproxy::resolve("glUniform3f");
  if (gd_noProgramBound())
    return;
  if (location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
...
extern "C" __declspec(dllexport) void WINAPI
gl_glUniform4f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) {
  static PFN_U4F p = nullptr;
  if (!p)
    p = (PFN_U4F)glproxy::resolve("glUniform4f");
  if (gd_noProgramBound())
    return;
  if (location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    ...
    auto &e = c[uniHash(g_currentProgram, location)];
    if (e.prog == g_currentProgram && e.loc == location && e.val[0] == v0 &&
        e.val[1] == v1 && e.val[2] == v2 && e.val[3] == v3)
      return;
    e.prog = g_currentProgram;
    e.loc = location;
    e.val[0] = v0;
...
extern "C" __declspec(dllexport) void WINAPI gl_glUniform1i(GLint location,
                                                            GLint v0) {
  static PFN_U1I p = nullptr;
  if (!p)
    p = (PFN_U1I)glproxy::resolve("glUniform1i");
  if (gd_noProgramBound())
    return;
  if (location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
...
extern "C" __declspec(dllexport) void WINAPI gl_glUniform2i(GLint location,
                                                            GLint v0,
                                                            GLint v1) {
  static PFN_U2I p = nullptr;
  if (!p)
    p = (PFN_U2I)glproxy::resolve("glUniform2i");
  if (gd_noProgramBound())
    return;
  if (location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
...
GLP_EXT_FORWARD_VOID(Uniform3i, (GLint location, GLint v0, GLint v1, GLint v2),
                     (location, v0, v1, v2))
GLP_EXT_FORWARD_VOID(Uniform4i,
...
extern "C" __declspec(dllexport) void WINAPI
gl_glUniform1fv(GLint location, GLsizei count, const GLfloat *value) {
  static PFN_U1FV p = nullptr;
  if (!p)
    p = (PFN_U1FV)glproxy::resolve("glUniform1fv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    thread_local UniCache<GLfloat, 1> c[UN_HASH_N] = {};
    auto &e = c[uniHash(g_currentProgram, location)];
    if (e.prog == g_currentProgram && e.loc == location && e.val[0] == value[0])
      return;
    e.prog = g_currentProgram;
    e.loc = location;
    e.val[0] = value[0];
...
extern "C" __declspec(dllexport) void WINAPI
gl_glUniform2fv(GLint location, GLsizei count, const GLfloat *value) {
  static PFN_U2FV p = nullptr;
  if (!p)
    p = (PFN_U2FV)glproxy::resolve("glUniform2fv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    thread_local UniCache<GLfloat, 2> c[UN_HASH_N] = {};
...
extern "C" __declspec(dllexport) void WINAPI
gl_glUniform3fv(GLint location, GLsizei count, const GLfloat *value) {
  static PFN_U3FV p = nullptr;
  if (!p)
    p = (PFN_U3FV)glproxy::resolve("glUniform3fv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    thread_local UniCache<GLfloat, 3> c[UN_HASH_N] = {};
...
gl_glUniform4fv(GLint location, GLsizei count, const GLfloat *value) {
  ...
  if (!p)
    p = (PFN_U4FV)glproxy::resolve("glUniform4fv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    thread_local UniCache<GLfloat, 4> c[UN_HASH_N] = {};
...
extern "C" __declspec(dllexport) void WINAPI
gl_glUniform1iv(GLint location, GLsizei count, const GLint *value) {
  static PFN_U1IV p = nullptr;
  if (!p)
    p = (PFN_U1IV)glproxy::resolve("glUniform1iv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    thread_local UniCache<GLint, 1> c[UN_HASH_N] = {};
...
extern "C" __declspec(dllexport) void WINAPI
gl_glUniform2iv(GLint location, GLsizei count, const GLint *value) {
  static PFN_U2IV p = nullptr;
  if (!p)
    p = (PFN_U2IV)glproxy::resolve("glUniform2iv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    thread_local UniCache<GLint, 2> c[UN_HASH_N] = {};
...
GLP_EXT_FORWARD_VOID(Uniform3iv,
                     (GLint location, GLsizei count, const GLint *value),
                     (location, count, value))
// glUniform4iv (count==1) dedup.
typedef void(WINAPI *PFN_U4IV)(GLint, GLsizei, const GLint *);
extern "C" __declspec(dllexport) void WINAPI
gl_glUniform4iv(GLint location, GLsizei count, const GLint *value) {
  static PFN_U4IV p = nullptr;
  if (!p)
    p = (PFN_U4IV)glproxy::resolve("glUniform4iv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
...
GLP_EXT_FORWARD_VOID(UniformMatrix2fv,
...
extern "C" __declspec(dllexport) void WINAPI gl_glUniformMatrix3fv(
  ...
  if (!p)
    p = (PFN_UM3FV)glproxy::resolve("glUniformMatrix3fv");
  if (gd_noProgramBound())
    return;
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    ...
    auto &e = c[uniHash(g_currentProgram, location)];
    if (e.prog == g_currentProgram && e.loc == location &&
        std::memcmp(e.val, value, sizeof(float) * 9) == 0)
      return;
    e.prog = g_currentProgram;
    e.loc = location;
...
extern thread_local GLuint g_currentProgram;
extern "C" __declspec(dllexport) void WINAPI gl_glUniformMatrix4fv(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) {
  static PFN_UM4FV p = nullptr;
  if (!p)
    p = (PFN_UM4FV)glproxy::resolve("glUniformMatrix4fv");
  if (gd_noProgramBound())
    return; // desktop-GL parity: silent no-op
  if (count == 1 && value && location >= 0 && g_currentProgram != 0xFFFFFFFFu) {
    struct E {
    ...
    size_t h =
        ((size_t)g_currentProgram * 2654435761u + (size_t)location) & (N - 1);
    E &e = cache[h];
    if (e.prog == g_currentProgram && e.loc == location &&
...
extern "C" void gdangle_invalidateAllStateCaches() {
  ...
  for (int i = 0; i < 8; i++)
    g_bufferBindings[i] = 0xFFFFFFFFu;
...
typedef void(WINAPI *PFN_VAP)(GLuint, GLint, GLenum, GLboolean, GLsizei,
                              const void *);
extern "C" __declspec(dllexport) void WINAPI gl_glVertexAttribPointer(
  ...
  if (!p)
    p = (PFN_VAP)glproxy::resolve("glVertexAttribPointer");
  if (index < 16) {
    VAPCacheEntry &e = g_vapCache[index];
    if (e.valid && e.size == size && e.type == type &&
...
extern "C" __declspec(dllexport) void WINAPI
gl_glEnableVertexAttribArray(GLuint index) {
  static PFN_EVAA p = nullptr;
  if (!p)
    p = (PFN_EVAA)glproxy::resolve("glEnableVertexAttribArray");
  if (index < 32) {
    unsigned int mask = 1u << index;
    if (g_vaaEnabledMask & mask)
      return;
...
extern "C" __declspec(dllexport) void WINAPI
gl_glDisableVertexAttribArray(GLuint index) {
  static PFN_EVAA p = nullptr;
  if (!p)
    p = (PFN_EVAA)glproxy::resolve("glDisableVertexAttribArray");
  if (index < 32) {
    unsigned int mask = 1u << index;
    if (!(g_vaaEnabledMask & mask))
      return;
...
GLP_EXT_FORWARD_VOID(VertexAttrib2f, (GLuint index, GLfloat x, GLfloat y),
                     (index, x, y))
GLP_EXT_FORWARD_VOID(VertexAttrib3f,
                     (GLuint index, GLfloat x, GLfloat y, GLfloat z),
                     (index, x, y, z))
GLP_EXT_FORWARD_VOID(VertexAttrib4f,
                     (GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w),
                     (index, x, y, z, w))
GLP_EXT_FORWARD_VOID(VertexAttrib1fv, (GLuint index, const GLfloat *v),
                     (index, v))
GLP_EXT_FORWARD_VOID(VertexAttrib2fv, (GLuint index, const GLfloat *v),
                     (index, v))
GLP_EXT_FORWARD_VOID(VertexAttrib3fv, (GLuint index, const GLfloat *v),
                     (index, v))
GLP_EXT_FORWARD_VOID(VertexAttrib4fv, (GLuint index, const GLfloat *v),
                     (index, v))
...
extern "C" __declspec(dllexport) void WINAPI
gl_glBindFramebuffer(GLenum target, GLuint framebuffer) {
  static PFN_BFB p = nullptr;
  if (!p)
    p = (PFN_BFB)glproxy::resolve("glBindFramebuffer");
  static int n = 0;
  if (n < 30)
    angle::forceLog("glBindFramebuffer #%d: target=0x%X fb=%u", n, target,
                    framebuffer);
  n++;
  if (p)
    p(target, framebuffer);
}
GLP_EXT_FORWARD_VOID(FramebufferTexture2D,
                     (GLenum target, GLenum attachment, GLenum textarget,
                      GLuint texture, GLint level),
                     (target, attachment, textarget, texture, level))
GLP_EXT_FORWARD_VOID(FramebufferRenderbuffer,
                     (GLenum target, GLenum attachment,
                      GLenum renderbuffertarget, GLuint renderbuffer),
                     (target, attachment, renderbuffertarget, renderbuffer))
GLP_EXT_FORWARD(GLenum, CheckFramebufferStatus, (GLenum target), (target))
GLP_EXT_FORWARD_VOID(DeleteFramebuffers,
                     (GLsizei n, const GLuint *framebuffers), (n, framebuffers))
GLP_EXT_FORWARD(GLboolean, IsFramebuffer, (GLuint framebuffer), (framebuffer))
typedef void(WINAPI *PFN_BFB_EXT)(GLint, GLint, GLint, GLint, GLint, GLint,
...
extern "C" __declspec(dllexport) void WINAPI gl_glBlitFramebuffer(
  ...
  if (!p)
    p = (PFN_BFB_EXT)glproxy::resolve("glBlitFramebuffer");
  static int n = 0;
  if (Config::get().megahack_detected && n < 40) {
    angle::forceLog("glBlitFramebuffer #%d: src=(%d,%d)-(%d,%d) "
                    "dst=(%d,%d)-(%d,%d) mask=0x%04X filter=0x%04X",
                    n, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1,
...
GLP_EXT_FORWARD_VOID(GetFramebufferAttachmentParameteriv,
...
extern "C" __declspec(dllexport) void WINAPI
gl_glBindRenderbuffer(GLenum target, GLuint renderbuffer) {
  static PFN_BRB p = nullptr;
  if (!p)
    p = (PFN_BRB)glproxy::resolve("glBindRenderbuffer");
  if (target == 0x8D41 /*GL_RENDERBUFFER*/)
    g_currentRBO = renderbuffer;
  if (p)
...
static bool gd_noRBOBound() {
  if (g_currentRBO != 0 && g_currentRBO != 0xFFFFFFFFu)
    return false;
  static PFN_GIV2 pGetIv = nullptr;
  if (!pGetIv)
    pGetIv = (PFN_GIV2)glproxy::resolve("glGetIntegerv");
  if (!pGetIv)
    return false;
  GLint cur = 0;
...
extern "C" __declspec(dllexport) void WINAPI gl_glRenderbufferStorage(
  ...
  if (!p)
    p = (PFN_RBS)glproxy::resolve("glRenderbufferStorage");
  if (gd_noRBOBound())
    return; // desktop-GL parity: silent no-op
  if (p)
...
extern "C" __declspec(dllexport) void WINAPI
gl_glRenderbufferStorageMultisample(GLenum target, GLsizei samples,
                                    GLenum internalformat, GLsizei width,
                                    GLsizei height) {
  static PFN_RBSM p = nullptr;
  if (!p)
    p = (PFN_RBSM)glproxy::resolve("glRenderbufferStorageMultisample");
  if (gd_noRBOBound())
    return; // desktop-GL parity: silent no-op
  if (p)
...
extern "C" __declspec(dllexport) void WINAPI
gl_glDeleteRenderbuffers(GLsizei n, const GLuint *renderbuffers) {
  static PFN_DeleteRenderbuffers p = nullptr;
  if (!p)
    p = (PFN_DeleteRenderbuffers)glproxy::resolve("glDeleteRenderbuffers");
  if (p)
    p(n, renderbuffers);
...
GLP_EXT_FORWARD(GLboolean, IsRenderbuffer, (GLuint renderbuffer),
                (renderbuffer))

// Misc
GLP_EXT_FORWARD_VOID(StencilFuncSeparate,
                     (GLenum face, GLenum func, GLint ref, GLuint mask),
                     (face, func, ref, mask))
GLP_EXT_FORWARD_VOID(StencilMaskSeparate, (GLenum face, GLuint mask),
                     (face, mask))
GLP_EXT_FORWARD_VOID(StencilOpSeparate,
...
extern "C" __declspec(dllexport) void WINAPI
gl_glLoadMatrixf(const GLfloat * /*m*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glLoadMatrixd(const GLdouble * /*m*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glMultMatrixf(const GLfloat * /*m*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glMultMatrixd(const GLdouble * /*m*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glPushMatrix() {}
extern "C" __declspec(dllexport) void WINAPI gl_glPopMatrix() {}
extern "C" __declspec(dllexport) void WINAPI
gl_glOrtho(GLdouble /*l*/, GLdouble /*r*/, GLdouble /*b*/, GLdouble /*t*/,
           GLdouble /*n*/, GLdouble /*f*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glOrtho2D(GLdouble /*l*/,
                                                          GLdouble /*r*/,
                                                          GLdouble /*b*/,
                                                          GLdouble /*t*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glFrustum(GLdouble /*l*/, GLdouble /*r*/, GLdouble /*b*/, GLdouble /*t*/,
             GLdouble /*n*/, GLdouble /*f*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glTranslatef(GLfloat /*x*/,
                                                             GLfloat /*y*/,
                                                             GLfloat /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glTranslated(GLdouble /*x*/,
                                                             GLdouble /*y*/,
                                                             GLdouble /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glRotatef(GLfloat /*a*/,
                                                          GLfloat /*x*/,
                                                          GLfloat /*y*/,
                                                          GLfloat /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glRotated(GLdouble /*a*/,
                                                          GLdouble /*x*/,
                                                          GLdouble /*y*/,
                                                          GLdouble /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glScalef(GLfloat /*x*/,
                                                         GLfloat /*y*/,
                                                         GLfloat /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glScaled(GLdouble /*x*/,
                                                         GLdouble /*y*/,
                                                         GLdouble /*z*/) {}
...
extern "C" __declspec(dllexport) void WINAPI gl_glVertex2f(GLfloat /*x*/,
                                                           GLfloat /*y*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glVertex2i(GLint /*x*/,
                                                           GLint /*y*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glVertex3f(GLfloat /*x*/,
                                                           GLfloat /*y*/,
                                                           GLfloat /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glVertex3d(GLdouble /*x*/,
                                                           GLdouble /*y*/,
                                                           GLdouble /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glVertex2fv(const GLfloat * /*v*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glVertex3fv(const GLfloat * /*v*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glNormal3f(GLfloat /*x*/,
                                                           GLfloat /*y*/,
                                                           GLfloat /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glNormal3fv(const GLfloat * /*v*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glColor3f(GLfloat /*r*/,
                                                          GLfloat /*g*/,
                                                          GLfloat /*b*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glColor3ub(GLubyte /*r*/,
                                                           GLubyte /*g*/,
                                                           GLubyte /*b*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glColor4f(GLfloat /*r*/,
                                                          GLfloat /*g*/,
                                                          GLfloat /*b*/,
                                                          GLfloat /*a*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glColor4ub(GLubyte /*r*/,
                                                           GLubyte /*g*/,
                                                           GLubyte /*b*/,
                                                           GLubyte /*a*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glColor4fv(const GLfloat * /*v*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glTexCoord2f(GLfloat /*s*/,
                                                             GLfloat /*t*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glTexCoord2fv(const GLfloat * /*v*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glRasterPos2f(GLfloat /*x*/,
                                                              GLfloat /*y*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glRasterPos2i(GLint /*x*/,
                                                              GLint /*y*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glRasterPos3f(GLfloat /*x*/,
                                                              GLfloat /*y*/,
                                                              GLfloat /*z*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glRasterPos2fv(const GLfloat * /*v*/) {}
...
extern "C" __declspec(dllexport) void WINAPI
gl_glPushAttrib(GLbitfield /*mask*/) {
  ...
  if (pGetB)
    pGetB(0x0C23 /*GL_COLOR_WRITEMASK*/, s.colorMask);
  else {
  ...
  pGetI(0x0B74 /*GL_DEPTH_FUNC*/, &s.depthFunc);
  {
    GLboolean dm = 1;
    if (pGetB)
      pGetB(0x0B72 /*GL_DEPTH_WRITEMASK*/, &dm);
    s.depthMask = dm;
  }
  {
    ...
    if (pGetFloatv)
      pGetFloatv(0x0B70 /*GL_DEPTH_RANGE*/, s.depthRange);
    else {
      s.depthRange[0] = 0.0f;
      s.depthRange[1] = 1.0f;
    }
  ...
  // Clear color
  {
    ...
    if (!pGetFloatv)
      pGetFloatv = (PFN_GF)glproxy::resolve("glGetFloatv");
    if (pGetFloatv)
      pGetFloatv(0x0C22 /*GL_COLOR_CLEAR_VALUE*/, s.clearColor);
    else {
  ...
  if (!pGetVertexAttribiv)
    pGetVertexAttribiv = (PFN_GVAIV)glproxy::resolve("glGetVertexAttribiv");
  ...
  for (int i = 0; i < 16; ++i) {
    ...
    if (!pGetVertexAttribiv)
      continue;
    GLint tmp = 0;
    pGetVertexAttribiv((GLuint)i, 0x8622 /*ARRAY_ENABLED*/, &tmp);
    a.enabled = (GLboolean)tmp;
    pGetVertexAttribiv((GLuint)i, 0x8623 /*ARRAY_SIZE*/, &tmp);
    a.size = tmp;
    pGetVertexAttribiv((GLuint)i, 0x8625 /*ARRAY_TYPE*/, &tmp);
    a.type = (GLenum)tmp;
    pGetVertexAttribiv((GLuint)i, 0x886A /*ARRAY_NORMALIZED*/, &tmp);
    a.normalized = (GLboolean)tmp;
    pGetVertexAttribiv((GLuint)i, 0x8624 /*ARRAY_STRIDE*/, &tmp);
    a.stride = (GLsizei)tmp;
    pGetVertexAttribiv((GLuint)i, 0x889F /*ARRAY_BUFFER_BINDING*/, &tmp);
    a.buffer = (GLuint)tmp;
    pGetVertexAttribiv((GLuint)i, 0x88FE /*ARRAY_DIVISOR*/, &tmp);
  ...
  if (Config::get().megahack_detected && n < 32) {
    angle::forceLog("glPushAttrib #%d: prog=%d active=0x%04X tex0=%d fbo=%d", n,
                    s.program, s.activeTexture, s.tex2D[0], s.drawFbo);
    n++;
  }
}
...
extern "C" __declspec(dllexport) void WINAPI gl_glPopAttrib() {
  ...
  if (!pBlendFuncSeparate)
    pBlendFuncSeparate = (PFN_BFS)glproxy::resolve("glBlendFuncSeparate");
  ...
  if (pBindBuffer) {
    ...
    pBindBuffer(0x8893 /*GL_ELEMENT_ARRAY_BUFFER*/,
                (GLuint)s.elementArrayBuffer);
  }
  for (int i = 0; i < 8; ++i) {
    if (pActiveTexture)
      pActiveTexture(0x84C0 + i);
    if (pBindTexture)
      pBindTexture(0x0DE1 /*GL_TEXTURE_2D*/, (GLuint)s.tex2D[i]);
  }
  if (pActiveTexture)
    pActiveTexture((GLenum)s.activeTexture);
  if (pViewport)
    pViewport(s.viewport[0], s.viewport[1], s.viewport[2], s.viewport[3]);
  if (pScissor)
    pScissor(s.scissorBox[0], s.scissorBox[1], s.scissorBox[2],
             s.scissorBox[3]);
  if (pColorMask)
    pColorMask(s.colorMask[0], s.colorMask[1], s.colorMask[2], s.colorMask[3]);
  ...
  if (pBlendFuncSeparate)
    pBlendFuncSeparate((GLenum)s.blendSrcRGB, (GLenum)s.blendDstRGB,
                       (GLenum)s.blendSrcAlpha, (GLenum)s.blendDstAlpha);
  if (pBlendEquationSeparate)
    pBlendEquationSeparate((GLenum)s.blendEqRGB, (GLenum)s.blendEqAlpha);
  ...
  // Stencil state restore (apply to both faces - safe for cocos2d's use)
  {
    ...
    if (pStencilFunc)
      pStencilFunc((GLenum)s.stencilFunc, s.stencilRef,
                   (GLuint)s.stencilValueMask);
    if (pStencilMask)
      pStencilMask((GLuint)s.stencilMask);
    if (pStencilOp)
      pStencilOp((GLenum)s.stencilOpFail, (GLenum)s.stencilOpZFail,
  ...
  // Clear color restore
  {
    ...
    if (pClearColor)
      pClearColor(s.clearColor[0], s.clearColor[1], s.clearColor[2],
                  s.clearColor[3]);
  }

  // Restore vertex attribute state. See struct comment in GdAttribSnapshot.
  typedef void(WINAPI * PFN_VAP_)(GLuint, GLint, GLenum, GLboolean, GLsizei,
                                  const void *);
  ...
  if (!pVertexAttribPointer)
    pVertexAttribPointer = (PFN_VAP_)glproxy::resolve("glVertexAttribPointer");
  if (!pEnableVAA)
    pEnableVAA = (PFN_E_)glproxy::resolve("glEnableVertexAttribArray");
  if (!pDisableVAA)
    pDisableVAA = (PFN_E_)glproxy::resolve("glDisableVertexAttribArray");
  if (!divisorResolved) {
  ...
  for (int i = 0; i < 16; ++i) {
    const auto &a = s.va[i];
    if (pBindBuffer)
      pBindBuffer(0x8892 /*GL_ARRAY_BUFFER*/, a.buffer);
    if (pVertexAttribPointer)
      pVertexAttribPointer((GLuint)i, a.size, a.type, a.normalized, a.stride,
                           a.pointer);
    if (pVertexAttribDivisor)
      pVertexAttribDivisor((GLuint)i, a.divisor);
    if (a.enabled) {
      if (pEnableVAA)
        pEnableVAA((GLuint)i);
      g_vaaEnabledMask |= (1u << i);
    } else {
      if (pDisableVAA)
        pDisableVAA((GLuint)i);
      g_vaaEnabledMask &= ~(1u << i);
    }
  }
  ...
  static int n = 0;
  if (Config::get().megahack_detected && n < 32) {
    angle::forceLog("glPopAttrib #%d: prog=%d active=0x%04X tex0=%d fbo=%d", n,
                    s.program, s.activeTexture, s.tex2D[0], s.drawFbo);
    n++;
  }
  gdangle_invalidateVAPCache();
...
extern "C" __declspec(dllexport) void WINAPI
gl_glPushClientAttrib(GLbitfield mask) {
  gl_glPushAttrib(mask);
}
extern "C" __declspec(dllexport) void WINAPI gl_glPopClientAttrib() {
  gl_glPopAttrib();
}

// --- Lighting / material / fog (GL 1.x) ---
extern "C" __declspec(dllexport) void WINAPI gl_glShadeModel(GLenum /*mode*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glLightf(GLenum /*light*/,
                                                         GLenum /*pname*/,
                                                         GLfloat /*param*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glLightfv(GLenum /*light*/, GLenum /*pname*/, const GLfloat * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glLightiv(GLenum /*light*/, GLenum /*pname*/, const GLint * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glLightModelf(GLenum /*pname*/, GLfloat /*param*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glLightModelfv(GLenum /*pname*/, const GLfloat * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glLightModeli(GLenum /*pname*/,
                                                              GLint /*param*/) {
}
extern "C" __declspec(dllexport) void WINAPI gl_glMaterialf(GLenum /*face*/,
                                                            GLenum /*pname*/,
                                                            GLfloat /*param*/) {
}
extern "C" __declspec(dllexport) void WINAPI gl_glMaterialfv(
    GLenum /*face*/, GLenum /*pname*/, const GLfloat * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glMateriali(GLenum /*face*/,
                                                            GLenum /*pname*/,
                                                            GLint /*param*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glColorMaterial(GLenum /*face*/, GLenum /*mode*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glFogf(GLenum /*pname*/,
                                                       GLfloat /*param*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glFogfv(GLenum /*pname*/, const GLfloat * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glFogi(GLenum /*pname*/,
                                                       GLint /*param*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glFogiv(GLenum /*pname*/, const GLint * /*params*/) {}

// --- Legacy pixel/texture ops (GL 1.x) ---
extern "C" __declspec(dllexport) void WINAPI gl_glLogicOp(GLenum /*opcode*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glAlphaFunc(GLenum /*func*/,
                                                            GLfloat /*ref*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glAccum(GLenum /*op*/,
                                                        GLfloat /*value*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glClearAccum(GLfloat /*r*/,
                                                             GLfloat /*g*/,
                                                             GLfloat /*b*/,
                                                             GLfloat /*a*/) {}
...
extern "C" __declspec(dllexport) void WINAPI gl_glRectf(GLfloat /*x1*/,
                                                        GLfloat /*y1*/,
                                                        GLfloat /*x2*/,
                                                        GLfloat /*y2*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glRecti(GLint /*x1*/,
                                                        GLint /*y1*/,
                                                        GLint /*x2*/,
                                                        GLint /*y2*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glBitmap(GLsizei /*w*/, GLsizei /*h*/, GLfloat /*xorig*/, GLfloat /*yorig*/,
            GLfloat /*xmove*/, GLfloat /*ymove*/, const GLubyte * /*bitmap*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glCopyPixels(
    GLint /*x*/, GLint /*y*/, GLsizei /*w*/, GLsizei /*h*/, GLenum /*type*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glDrawPixels(GLsizei /*w*/, GLsizei /*h*/, GLenum /*fmt*/, GLenum /*type*/,
                const GLvoid * /*pixels*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glTexEnvf(GLenum /*target*/,
                                                          GLenum /*pname*/,
                                                          GLfloat /*param*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glTexEnvfv(
    GLenum /*target*/, GLenum /*pname*/, const GLfloat * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glTexEnvi(GLenum /*target*/,
                                                          GLenum /*pname*/,
                                                          GLint /*param*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glTexEnviv(GLenum /*target*/, GLenum /*pname*/, const GLint * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glTexImage1D(
    GLenum /*target*/, GLint /*level*/, GLint /*ifmt*/, GLsizei /*w*/,
    GLint /*border*/, GLenum /*fmt*/, GLenum /*type*/, const GLvoid * /*px*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glTexImage3D(GLenum /*target*/, GLint /*level*/, GLint /*ifmt*/,
                GLsizei /*w*/, GLsizei /*h*/, GLsizei /*d*/, GLint /*border*/,
                GLenum /*fmt*/, GLenum /*type*/, const GLvoid * /*px*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glTexSubImage1D(GLenum /*t*/, GLint /*l*/, GLint /*xoff*/, GLsizei /*w*/,
                   GLenum /*fmt*/, GLenum /*type*/, const GLvoid * /*px*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glCopyTexImage1D(GLenum /*t*/, GLint /*l*/, GLenum /*ifmt*/, GLint /*x*/,
                    GLint /*y*/, GLsizei /*w*/, GLint /*border*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glGetTexImage(GLenum /*target*/,
                                                              GLint /*level*/,
                                                              GLenum /*fmt*/,
                                                              GLenum /*type*/,
                                                              GLvoid * /*px*/) {
}
extern "C" __declspec(dllexport) void WINAPI gl_glGetTexLevelParameteriv(
    GLenum /*target*/, GLint /*level*/, GLenum /*pname*/, GLint * /*params*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glGetTexLevelParameterfv(GLenum /*target*/, GLint /*level*/,
                            GLenum /*pname*/, GLfloat * /*params*/) {}

// --- Legacy array pointers (GL 1.1) ---
extern "C" __declspec(dllexport) void WINAPI
gl_glVertexPointer(GLint /*size*/, GLenum /*type*/, GLsizei /*stride*/,
                   const GLvoid * /*ptr*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glNormalPointer(
    GLenum /*type*/, GLsizei /*stride*/, const GLvoid * /*ptr*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glColorPointer(GLint /*size*/, GLenum /*type*/, GLsizei /*stride*/,
                  const GLvoid * /*ptr*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glTexCoordPointer(GLint /*size*/, GLenum /*type*/, GLsizei /*stride*/,
                     const GLvoid * /*ptr*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glIndexPointer(
    GLenum /*type*/, GLsizei /*stride*/, const GLvoid * /*ptr*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glEdgeFlagPointer(GLsizei /*stride*/, const GLvoid * /*ptr*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glEnableClientState(GLenum /*array*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glDisableClientState(GLenum /*array*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glClientActiveTexture(GLenum /*texture*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glMultiTexCoord2f(GLenum /*target*/, GLfloat /*s*/, GLfloat /*t*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glMultiTexCoord2fv(GLenum /*target*/, const GLfloat * /*v*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glInterleavedArrays(
    GLenum /*format*/, GLsizei /*stride*/, const GLvoid * /*ptr*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glArrayElement(GLint /*i*/) {}

// --- Display lists (GL 1.x) ---
extern "C" __declspec(dllexport) GLuint WINAPI
gl_glGenLists(GLsizei /*range*/) {
  return 0;
}
extern "C" __declspec(dllexport) void WINAPI gl_glNewList(GLuint /*list*/,
                                                          GLenum /*mode*/) {}
...
extern "C" __declspec(dllexport) void WINAPI
gl_glCallLists(GLsizei /*n*/, GLenum /*type*/, const GLvoid * /*lists*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glDeleteLists(GLuint /*list*/, GLsizei /*range*/) {}
extern "C" __declspec(dllexport) GLboolean WINAPI gl_glIsList(GLuint /*list*/) {
  return GL_FALSE;
}
...
gl_glDrawRangeElements(GLenum mode, GLuint /*start*/, GLuint /*end*/,
  ...
  if (!p)
    p = (PFN)glproxy::resolve("glDrawElements");
  if (p)
    p(mode, count, type, indices);
}
extern "C" __declspec(dllexport) void WINAPI gl_glMultiDrawArrays(
    GLenum mode, const GLint *first, const GLsizei *count, GLsizei drawcount) {
  typedef void(WINAPI * PFN)(GLenum, GLint, GLsizei);
  static PFN p = nullptr;
  if (!p)
    p = (PFN)glproxy::resolve("glDrawArrays");
  if (p)
    for (GLsizei i = 0; i < drawcount; i++)
      p(mode, first[i], count[i]);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glMultiDrawElements(GLenum mode, const GLsizei *count, GLenum type,
  ...
  if (p)
    for (GLsizei i = 0; i < drawcount; i++)
      p(mode, count[i], type, indices[i]);
}

// --- GL 3.x+ desktop stubs (geometry shaders, transform feedback, queries) ---
extern "C" __declspec(dllexport) void WINAPI
gl_glBeginTransformFeedback(GLenum /*primitiveMode*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glEndTransformFeedback() {}
extern "C" __declspec(dllexport) void WINAPI gl_glTransformFeedbackVaryings(
    GLuint /*prog*/, GLsizei /*count*/, const GLchar *const * /*varyings*/,
    GLenum /*mode*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glGetTransformFeedbackVarying(
    GLuint /*prog*/, GLuint /*idx*/, GLsizei /*bufSize*/, GLsizei * /*len*/,
    GLsizei * /*size*/, GLenum * /*type*/, GLchar * /*name*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glPatchParameteri(GLenum /*pname*/, GLint /*value*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glPatchParameterfv(GLenum /*pname*/, const GLfloat * /*values*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glDrawArraysInstanced(
  ...
  if (!pInst)
    pInst = (PFN_I)glproxy::resolve("glDrawArraysInstanced");
  if (!pPlain)
    pPlain = (PFN_P)glproxy::resolve("glDrawArrays");
  if (pInst)
    pInst(mode, first, count, instancecount);
  else if (pPlain)
    pPlain(mode, first, count);
}
extern "C" __declspec(dllexport) void WINAPI
gl_glDrawElementsInstanced(GLenum mode, GLsizei count, GLenum type,
                           const GLvoid *indices, GLsizei instancecount) {
  typedef void(WINAPI * PFN_I)(GLenum, GLsizei, GLenum, const GLvoid *,
                               GLsizei);
  typedef void(WINAPI * PFN_P)(GLenum, GLsizei, GLenum, const GLvoid *);
  static PFN_I pInst = nullptr;
  static PFN_P pPlain = nullptr;
  if (!pInst)
    pInst = (PFN_I)glproxy::resolve("glDrawElementsInstanced");
  if (!pPlain)
    pPlain = (PFN_P)glproxy::resolve("glDrawElements");
  if (pInst)
    pInst(mode, count, type, indices, instancecount);
  else if (pPlain)
...
GLP_EXT_FORWARD_VOID(GetQueryiv, (GLenum target, GLenum pname, GLint *params),
                     (target, pname, params))
GLP_EXT_FORWARD_VOID(GetQueryObjectiv, (GLuint id, GLenum pname, GLint *params),
                     (id, pname, params))
GLP_EXT_FORWARD_VOID(GetQueryObjectuiv,
...
extern "C" __declspec(dllexport) GLsync_t WINAPI
gl_glFenceSync(GLenum condition, GLbitfield flags) {
  static PFN_FS p = nullptr;
  if (!p)
    p = (PFN_FS)glproxy::resolve("glFenceSync");
  return p ? p(condition, flags) : nullptr;
}
typedef GLenum(WINAPI *PFN_CWS)(GLsync_t, GLbitfield, GLuint64);
extern "C" __declspec(dllexport) GLenum WINAPI
gl_glClientWaitSync(GLsync_t sync, GLbitfield flags, GLuint64 timeout) {
  static PFN_CWS p = nullptr;
  if (!p)
    p = (PFN_CWS)glproxy::resolve("glClientWaitSync");
  return p ? p(sync, flags, timeout) : 0x911A /*GL_WAIT_FAILED*/;
}
typedef void(WINAPI *PFN_WS)(GLsync_t, GLbitfield, GLuint64);
extern "C" __declspec(dllexport) void WINAPI gl_glWaitSync(GLsync_t sync,
                                                           GLbitfield flags,
                                                           GLuint64 timeout) {
  static PFN_WS p = nullptr;
  if (!p)
    p = (PFN_WS)glproxy::resolve("glWaitSync");
  if (p)
...
extern "C" __declspec(dllexport) void WINAPI gl_glDeleteSync(GLsync_t sync) {
  ...
  if (!p)
    p = (PFN_DS)glproxy::resolve("glDeleteSync");
  if (p)
    p(sync);
}
...
extern "C" __declspec(dllexport) GLboolean WINAPI gl_glIsSync(GLsync_t sync) {
  ...
  if (!p)
    p = (PFN_IS)glproxy::resolve("glIsSync");
  return p ? p(sync) : GL_FALSE;
}

// --- Uniform buffer objects (GL 3.1 / GLES 3.0) ---
GLP_EXT_FORWARD(GLuint, GetUniformBlockIndex,
                (GLuint program, const GLchar *name), (program, name))
GLP_EXT_FORWARD_VOID(UniformBlockBinding,
                     (GLuint program, GLuint index, GLuint binding),
                     (program, index, binding))
GLP_EXT_FORWARD_VOID(GetActiveUniformBlockiv,
                     (GLuint program, GLuint index, GLenum pname,
                      GLint *params),
                     (program, index, pname, params))
GLP_EXT_FORWARD_VOID(GetActiveUniformBlockName,
                     (GLuint program, GLuint index, GLsizei bufSize,
                      GLsizei *length, GLchar *name),
                     (program, index, bufSize, length, name))
GLP_EXT_FORWARD_VOID(BindBufferBase,
                     (GLenum target, GLuint index, GLuint buffer),
                     (target, index, buffer))
GLP_EXT_FORWARD_VOID(BindBufferRange,
                     (GLenum target, GLuint index, GLuint buffer,
                      GLintptr offset, GLsizeiptr size),
                     (target, index, buffer, offset, size))

// --- Program binary (GL 4.1 / GLES 3.0) ---
GLP_EXT_FORWARD_VOID(GetProgramBinary,
                     (GLuint program, GLsizei bufSize, GLsizei *length,
                      GLenum *binaryFormat, void *binary),
                     (program, bufSize, length, binaryFormat, binary))
GLP_EXT_FORWARD_VOID(ProgramBinary,
                     (GLuint program, GLenum binaryFormat, const void *binary,
                      GLsizei length),
                     (program, binaryFormat, binary, length))
GLP_EXT_FORWARD_VOID(ProgramParameteri,
                     (GLuint program, GLenum pname, GLint value),
                     (program, pname, value))

// --- Vertex attrib integer / double (GL 3.0+) ---
GLP_EXT_FORWARD_VOID(VertexAttribIPointer,
                     (GLuint index, GLint size, GLenum type, GLsizei stride,
                      const void *pointer),
                     (index, size, type, stride, pointer))
GLP_EXT_FORWARD_VOID(VertexAttribDivisor, (GLuint index, GLuint divisor),
                     (index, divisor))
GLP_EXT_FORWARD_VOID(GetVertexAttribIiv,
                     (GLuint index, GLenum pname, GLint *params),
                     (index, pname, params))
GLP_EXT_FORWARD_VOID(GetVertexAttribIuiv,
...
GLP_EXT_FORWARD_VOID(Uniform2ui, (GLint loc, GLuint v0, GLuint v1),
                     (loc, v0, v1))
GLP_EXT_FORWARD_VOID(Uniform3ui, (GLint loc, GLuint v0, GLuint v1, GLuint v2),
                     (loc, v0, v1, v2))
GLP_EXT_FORWARD_VOID(Uniform4ui,
                     (GLint loc, GLuint v0, GLuint v1, GLuint v2, GLuint v3),
                     (loc, v0, v1, v2, v3))
GLP_EXT_FORWARD_VOID(Uniform1uiv, (GLint loc, GLsizei count, const GLuint *v),
                     (loc, count, v))
GLP_EXT_FORWARD_VOID(Uniform2uiv, (GLint loc, GLsizei count, const GLuint *v),
                     (loc, count, v))
GLP_EXT_FORWARD_VOID(Uniform3uiv, (GLint loc, GLsizei count, const GLuint *v),
                     (loc, count, v))
GLP_EXT_FORWARD_VOID(Uniform4uiv, (GLint loc, GLsizei count, const GLuint *v),
                     (loc, count, v))
GLP_EXT_FORWARD_VOID(UniformMatrix2x3fv,
                     (GLint loc, GLsizei count, GLboolean t, const GLfloat *v),
                     (loc, count, t, v))
GLP_EXT_FORWARD_VOID(UniformMatrix3x2fv,
                     (GLint loc, GLsizei count, GLboolean t, const GLfloat *v),
                     (loc, count, t, v))
GLP_EXT_FORWARD_VOID(UniformMatrix2x4fv,
                     (GLint loc, GLsizei count, GLboolean t, const GLfloat *v),
                     (loc, count, t, v))
GLP_EXT_FORWARD_VOID(UniformMatrix4x2fv,
                     (GLint loc, GLsizei count, GLboolean t, const GLfloat *v),
                     (loc, count, t, v))
GLP_EXT_FORWARD_VOID(UniformMatrix3x4fv,
                     (GLint loc, GLsizei count, GLboolean t, const GLfloat *v),
                     (loc, count, t, v))
GLP_EXT_FORWARD_VOID(UniformMatrix4x3fv,
                     (GLint loc, GLsizei count, GLboolean t, const GLfloat *v),
                     (loc, count, t, v))

// --- Sampler objects (GL 3.3 / GLES 3.0) ---
GLP_EXT_FORWARD_VOID(GenSamplers, (GLsizei count, GLuint *samplers),
                     (count, samplers))
GLP_EXT_FORWARD_VOID(DeleteSamplers, (GLsizei count, const GLuint *samplers),
                     (count, samplers))
GLP_EXT_FORWARD(GLboolean, IsSampler, (GLuint sampler), (sampler))
GLP_EXT_FORWARD_VOID(SamplerParameteri,
                     (GLuint sampler, GLenum pname, GLint param),
                     (sampler, pname, param))
GLP_EXT_FORWARD_VOID(SamplerParameterf,
                     (GLuint sampler, GLenum pname, GLfloat param),
                     (sampler, pname, param))
GLP_EXT_FORWARD_VOID(SamplerParameteriv,
                     (GLuint sampler, GLenum pname, const GLint *params),
                     (sampler, pname, params))
GLP_EXT_FORWARD_VOID(SamplerParameterfv,
                     (GLuint sampler, GLenum pname, const GLfloat *params),
                     (sampler, pname, params))
GLP_EXT_FORWARD_VOID(GetSamplerParameteriv,
                     (GLuint sampler, GLenum pname, GLint *params),
                     (sampler, pname, params))
GLP_EXT_FORWARD_VOID(GetSamplerParameterfv,
                     (GLuint sampler, GLenum pname, GLfloat *params),
                     (sampler, pname, params))

// --- Texture storage (GL 4.2 / GLES 3.0) ---
GLP_EXT_FORWARD_VOID(TexStorage2D,
                     (GLenum target, GLsizei levels, GLenum ifmt, GLsizei w,
                      GLsizei h),
                     (target, levels, ifmt, w, h))
GLP_EXT_FORWARD_VOID(TexStorage3D,
                     (GLenum target, GLsizei levels, GLenum ifmt, GLsizei w,
                      GLsizei h, GLsizei d),
                     (target, levels, ifmt, w, h, d))
GLP_EXT_FORWARD_VOID(TexSubImage3D,
                     (GLenum t, GLint l, GLint xo, GLint yo, GLint zo,
                      GLsizei w, GLsizei h, GLsizei d, GLenum fmt, GLenum type,
                      const GLvoid *px),
                     (t, l, xo, yo, zo, w, h, d, fmt, type, px))
GLP_EXT_FORWARD_VOID(TexImage2DMultisample,
                     (GLenum target, GLsizei samples, GLenum ifmt, GLsizei w,
                      GLsizei h, GLboolean fixedLoc),
                     (target, samples, ifmt, w, h, fixedLoc))

// --- Get double/int64 (GL 3.2+) ---
extern "C" __declspec(dllexport) void WINAPI gl_glGetDoublev(GLenum pname,
                                                             GLdouble *data) {
  typedef void(WINAPI * PFN)(GLenum, GLfloat *);
  static PFN p = nullptr;
  if (!p)
    p = (PFN)glproxy::resolve("glGetFloatv");
  if (!p || !data)
    return;
  GLfloat tmp = 0.0f;
  p(pname, &tmp);
...
extern "C" __declspec(dllexport) void WINAPI gl_glGetInteger64v(GLenum pname,
                                                                GLint64 *data) {
  typedef void(WINAPI * PFN)(GLenum, GLint *);
  static PFN p = nullptr;
  if (!p)
    p = (PFN)glproxy::resolve("glGetIntegerv");
  if (!p || !data)
    return;
  GLint tmp = 0;
  p(pname, &tmp);
...
// --- Misc desktop-only ---
extern "C" __declspec(dllexport) void WINAPI
gl_glPassThrough(GLfloat /*token*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glSelectBuffer(GLsizei /*size*/, GLuint * /*buffer*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glFeedbackBuffer(GLsizei /*size*/, GLenum /*type*/, GLfloat * /*buffer*/) {}
extern "C" __declspec(dllexport) GLint WINAPI gl_glRenderMode(GLenum /*mode*/) {
  return 0;
}
...
extern "C" __declspec(dllexport) void WINAPI
gl_glLineStipple(GLint /*factor*/, GLushort /*pattern*/) {}
extern "C" __declspec(dllexport) void WINAPI gl_glEdgeFlag(GLboolean /*flag*/) {
}
extern "C" __declspec(dllexport) void WINAPI
gl_glClipPlane(GLenum /*plane*/, const GLdouble * /*eq*/) {}
extern "C" __declspec(dllexport) void WINAPI
gl_glGetClipPlane(GLenum /*plane*/, GLdouble * /*eq*/) {}